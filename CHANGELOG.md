...
* **scoring:** added ELL scoring ([b60f9e7](https://github.com/seiyria/openchallenge/commit/b60f9e7)), closes [#14](https://github.com/seiyria/openchallenge/issues/14)
* **tournaments:** Added FFA tournaments ([e76ac59](https://github.com/seiyria/openchallenge/commit/e76ac59))
* **tournaments:** added link button to allow for easier copying of tournament urls ([768da4d](https://github.com/seiyria/openchallenge/commit/768da4d)), closes [#50](https://github.com/seiyria/openchallenge/issues/50)
