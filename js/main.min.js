...
exports['default'] = angular.module('openchallenge', ['ngAria', 'ngAnimate', 'ngMaterial', 'ngMdIcons', 'ngStorage', 'ui.router', 'firebase', 'md.data.table', 'angular-sortable-view', 'ngSanitize']);
...
_app2['default'].controller('userManageController', function ($scope, $firebaseArray, $firebaseObject, $state, $stateParams, Auth, FirebaseURL, ScoringFunctions, CurrentUsers, InputPrompt, UserStatus, CurrentPlayerBucket, CurrentTournaments, ShareManagement, SetManagement, SidebarManagement, EnsureLoggedIn, UserManagement, TournamentStatus, Toaster) {
  ...
  $scope.allTournamentGames = function () {
    return _($scope.tournaments).filter(function (t) {
  ...
  $scope.recalculateScore = function () {
    ...
    var currentGame = $scope.userData.firebase.scoreGame;
